		...
		<div class="row">
          ...
          ?>
                ...
                <?php
                  ...
                  foreach($rows as $row):
                ?>
								<li><a class="dropdown-item @@dashboardPage" href="/user/industries/<?=$row['IndustryId']?>"><i class="fa fa-industry"></i>  <?=$row['Nameindustry']?> </a></li>
                <?php 
                  endforeach; 
                  endif; 
                ?>
              ...
              <li class="nav-item dropdown">
								<a class="nav-link" href="/user/aplications">Aplications</a>
							</li>

              
              <li class="nav-item dropdown">
								<a class="nav-link" href="/user/profile-controller">Profile</a>
							</li>
						</ul>
            <?php  }else{
             // echo 'no data';
