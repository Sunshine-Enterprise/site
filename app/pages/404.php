    ...
    <!--min-vh-100-->
      <div class="slide1 py-5 bg-cover d-flex align-items-center" id='hero-slider'>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
                <h3 class="text-light text-uppercase h1 text-center display-3" id="title">404</h3>
              <h3 class="text-light text-uppercase h1 text-center" id="title">I'm Sorry</h3>
              <h6 class="text-light displa-3 h3 fst-italic pb-3 text-center" id="title">We can't find your page</h6>
            </div>
          </div>
        </div>
      </div>
