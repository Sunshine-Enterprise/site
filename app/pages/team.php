      ...
      <div class="container text-center">
        ...
        <div class="row featurette">
          <div class="col-lg-12 col-md-12">
            <p class="fst-italic mt-3">Our team is at the core of who we are. Each individual is integral to the success of Sunshine Project Management.</p>
            <p class="fst-italic mt-3">We wouldn’t be where we are today without them.</p>
        ...
        <div class="container marketing">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-6">
                <img src="assets/img/team/sam.jpg" style="width:150px; border-radius: 10%;" >
                
                <h2 class="fw-semibold py-2">Sam Faragalla</h2>
                <p class="text-center display-5 h6" id="subtitle-about">CEO/ Founder</p>

                <p class="p-team">Sam Faragalla, MA, SHRM-SCP is an expert in the Staffing and Recruitment industry. He is a Human Resources Executive with over 15 years of comprehensive human resources experience including staffing, recruitment and retention, conflict resolution, change management, labor relations, and benefits administration.</p>
                <p class="text-dark"> <a class="btn border text-dark fw-bold" href="https://www.linkedin.com/in/sam-faragalla-ma-shrm-scp-a224171b/">Linked  <i class="fa fa-linkedin text-primary"></i></a></p>
              </div><!-- /.col-lg-4 -->
              <div class="col-lg-6 col-6">
                <img src="assets/img/team/rania.jpg" style="width:150px; border-radius: 10%;" >
                <h2 class="fw-semibold py-2">Rania Hanna</h2>
                <p class="text-center display-5 h6" id="subtitle-about">President/ Founder</p>
                <p class="p-team">Rania is a results-orientated professional, offering over 15 years of progressive responsibility in recruiting. Consistently recognized as strategic and a change agent with the proven ability to design, build and re-organize recruitment teams to meet or exceed corporate talent objectives.</p>
                <p class=""><a class="btn border text-dark fw-bold" href="https://www.linkedin.com/in/rania-g-hanna-9268068b?trk=org-employees">Linked <i class="fa fa-linkedin text-primary"></i></a></p>
              </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
