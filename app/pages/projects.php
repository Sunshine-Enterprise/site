...
<div class="container-fluid pt-4" >
 ...
 <!---SECTION-->
 <section class="py-1" id="services">
  <div class="container mb-5">
    <div class="row g-3">
      <div class="col-12 intro text-center">
        <p class="text-center fst-italic">List of SEU projects</p>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 col-sm-6 pb-4">
        <a href="carrers">
          <div class="card_services rounded p-0">
            <img src="assets/img/horizontal/pexels-rodolfo-quirós-2219024.jpg" class="rounded-top" alt="">
            <div class="overlay">
              <h3 class="text-light fst-italic text-center" style="margin-top: 50%;"></h3>
            </div>
            <div class="cart-body p-3 text-center">
              <p class="date-project fw-lighter">20-19-2023</p>
              <p class="text-start fst-italic m-0">Concrete</p>
              <h5 class="text-start">Concrete Finishing Road</h5>
              <h6 class="text-start fw-normal"><u>Orlando/FL</u></h6>
              </div>
            </div>
          </a>
      </div>
      ...
      <div class="col-lg-4 col-md-6 col-sm-6 pb-4">
        <a href="carrers">
          <div class="card_services rounded p-0">
            <img src="assets/img/horizontal/pexels-mali-maeder-68470.jpg" class="rounded-top" alt="">
            <div class="overlay">
              <h3 class="text-light fst-italic text-center" style="margin-top: 50%;"></h3>
            </div>
            <div class="cart-body p-3 text-center">
      ...
      <div class="col-lg-4 col-md-6 col-sm-6 pb-4">
        <a href="carrers">
          <div class="card_services rounded p-0">
            <img src="assets/img/horizontal/pexels-nathan-cowley-713297.jpg" class="rounded-top" alt="">
            <div class="overlay">
              <h3 class="text-light fst-italic text-center" style="margin-top: 50%;"></h3>
            </div>
            <div class="cart-body p-3 text-center">
                ...
                <div class="row text-center">
                  <div class="col-sm">
                    <p class="top">
                      ...
                      <span class="fw-bold text-secondary">spm@seu-usa.com</span>
                    </p>
                  </div>
