                      ...
                      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        <div class="col p-4 d-flex flex-column position-static">
                            <div>
                                ...
                                <div class="mb-1 text-body-secondary" id="tag-blog">08/12</div>
                            </div>
                          <h3 class="mb-0 pb-2" id="title-blog">We're Hiring Concrete Foreman</h3>

                          
                          <p class="card-text mb-1" id="date-content">Sunshine Project Management. We are looking for Concrete Foreman. this is a Full-Time Position.</p>
                          <a class="icon-link icon-link-hover text-dark rounded fw-bold p-2" id="apply-button" style="--bs-link-hover-color-rgb: 25, 135, 84;" href="job">
                            Apply here
                          </a>
                        </div>
                      </div>
